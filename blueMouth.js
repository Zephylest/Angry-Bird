...
function main() {
    ...
    var animate = function (time) {
        var yRotation = (Math.sin(time/150)*0.25-0.1);
        ...
        LIBS.translateY(MODEL_MATRIX4, baseY1);
        LIBS.translateX(MODEL_MATRIX4, 4);
        LIBS.translateZ(MODEL_MATRIX4, 5);
        ...
        LIBS.translateX(MODEL_MATRIX2, 0);
        LIBS.translateY(MODEL_MATRIX2, baseY2);
        ...
        LIBS.translateX(MODEL_MATRIX3, 0);
        LIBS.translateY(MODEL_MATRIX3, baseY2);
        LIBS.rotateX(MODEL_MATRIX3, 0.3 + yRotation);
        LIBS.translateZ(MODEL_MATRIX3, 5);
        ...
        LIBS.translateX(MODEL_MATRIX, 0);
        LIBS.translateZ(MODEL_MATRIX, 0);
        LIBS.translateY(MODEL_MATRIX, baseY3);
