...
function main() {
    ...
    var animate = function (time) {
        var jumpHeight = Math.sin(time/150) + 1;
        ...
        LIBS.translateY(MODEL_MATRIX4, baseY1 + jumpHeight);
        ...
        LIBS.translateY(MODEL_MATRIX2, baseY2 + jumpHeight);
        ...
        LIBS.translateY(MODEL_MATRIX3, baseY2 + jumpHeight);
        ...
        LIBS.translateY(MODEL_MATRIX, baseY3 + jumpHeight);
